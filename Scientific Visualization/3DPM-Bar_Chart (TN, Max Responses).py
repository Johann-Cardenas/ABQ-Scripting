...
for cc in Case:
    ...
    for jj in range(1,18):
        ...
        E11 = [EE_max[0][0], EE_max[1][0], EE_max[2][0], EE_max[3][0]]
        E33 = [EE_max[0][2], EE_max[1][2], EE_max[2][2], EE_max[3][2]] 
        E22 = [EE_min[0][1], EE_min[1][1], EE_min[2][1], EE_min[3][1]]
         
        E23_Max = [EE_max[0][5], EE_max[1][5], EE_max[2][5], EE_max[3][5]]
        E23_Min = [EE_min[0][5], EE_min[1][5], EE_min[2][5], EE_min[3][5]]
        
        E13_Max = [EE_max[0][4], EE_max[1][4], EE_max[2][4], EE_max[3][4]]
        E13_Min = [EE_min[0][4], EE_min[1][4], EE_min[2][4], EE_min[3][4]]      
        
        E12_Max = [EE_max[0][3], EE_max[1][3], EE_max[2][3], EE_max[3][3]]
        E12_Min = [EE_min[0][3], EE_min[1][3], EE_min[2][3], EE_min[3][3]]      
        ...
        # ## Extracted Stress
        S11 = [SS_max[0][0], SS_max[1][0], SS_max[2][0], SS_max[3][0]]
        S33 = [SS_max[0][2], SS_max[1][2], SS_max[2][2], SS_max[3][2]] 			   
        S22 = [SS_min[0][1], SS_min[1][1], SS_min[2][1], SS_min[3][1]]
        S23_Min = [SS_max[0][5], SS_max[1][5], SS_max[2][5], SS_max[3][5]]
        S23_Max = [SS_min[0][5], SS_min[1][5], SS_min[2][5], SS_min[3][5]]
           
        S13_Min = [SS_max[0][4], SS_max[1][4], SS_max[2][4], SS_max[3][4]]
        S13_Max = [SS_min[0][4], SS_min[1][4], SS_min[2][4], SS_min[3][4]]
        
        S12_Min = [SS_max[0][3], SS_max[1][3], SS_max[2][3], SS_max[3][3]]
        S12_Max = [SS_min[0][3], SS_min[1][3], SS_min[2][3], SS_min[3][3]]      
...
plt.savefig("Thin_BottomUP_AC.png",bbox_inches='tight', dpi=1000)
plt.show()
